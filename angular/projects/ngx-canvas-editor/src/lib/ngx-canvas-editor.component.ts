...
import Editor, {
    Command, ControlState, ControlType, EditorMode, EditorZone, ElementType, ICatalogItem,
    KeyMap, ListStyle, ListType, PageMode, PaperDirection, RowFlex, splitText, TextDecorationStyle, TitleLevel,
} from '@hufe921/canvas-editor'
// import {nextTick, debounce} from '@hufe921/canvas-editor/dist/src/editor/utils';

@Component({
    selector: 'ngx-canvas-editor',
    imports: [],
    templateUrl: './ngx-canvas-editor.component.html',
    styleUrls: ['./ngx-canvas-editor.component.scss'],
})
export class NgxCanvasEditorComponent implements AfterViewInit {
    ngAfterViewInit() {
        const isApple =
            typeof navigator !== 'undefined' && /Mac OS X/.test(navigator.userAgent)
        const asdasd: any = document.querySelector('.canvas-editor')
        // ts-ignore
        const instance = new Editor(asdasd,
            [
                {
                    value: 'Hello World'
                }
